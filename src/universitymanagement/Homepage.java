...
public class Homepage extends JFrame implements ActionListener {
	Homepage() {
		...
		ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/uog.jpg"));
		Image i3 = ic.getImage().getScaledInstance(1100, 699, Image.SCALE_DEFAULT);
		...
		JMenuItem m1 = new JMenuItem("New Lecturer");
		JMenuItem m2 = new JMenuItem("New Student");
		add.setForeground(Color.BLACK);

		m1.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon1.png"));
		...
		ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon2.png"));
		...
		JMenu user = new JMenu("SHOW DETAILS");
		JMenuItem u1 = new JMenuItem("Student Details");
		JMenuItem u2 = new JMenuItem("Lecturer Details");
		user.setForeground(Color.BLACK);

		u1.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon3.png"));
		...
		ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon4.jpg"));
		...
		JMenuItem a2 = new JMenuItem("Lecturer Attendance");
		attendance.setForeground(Color.BLACK);

		a1.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon14.jpg"));
		...
		ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon15.png"));
		...
		JMenu attendance_detail = new JMenu("SHOW ATTENDANCE");
		JMenuItem b1 = new JMenuItem("Student Attendance Detail");
		JMenuItem b2 = new JMenuItem("Lecturer Attendance Detail");
		attendance_detail.setForeground(Color.BLACK);

		b1.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon15.png"));
		Image image28 = icon27.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
		b1.setIcon(new ImageIcon(image28));
		b1.setMnemonic('O');
		b1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V, ActionEvent.CTRL_MASK));
		b1.setBackground(Color.WHITE);
		attendance_detail.add(b1);

		b2.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon14.jpg"));
		Image image30 = icon29.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
		b2.setIcon(new ImageIcon(image30));
		b2.setMnemonic('P');
		b2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Y, ActionEvent.CTRL_MASK));
		...
		JMenuItem c2 = new JMenuItem("Input Marks");
		exam.setForeground(Color.BLACK);

		c1.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon16.png"));
		Image image31 = icon30.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
		c1.setIcon(new ImageIcon(image31));
		c1.setMnemonic('Q');
		c1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, ActionEvent.CTRL_MASK));
		c1.setBackground(Color.WHITE);
		exam.add(c1);

		c2.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon17.png"));
		Image image33 = icon32.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
		c2.setIcon(new ImageIcon(image33));
		c2.setMnemonic('R');
		c2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, ActionEvent.CTRL_MASK));
		...
		JMenu report = new JMenu("UPDATE RECORD");
		JMenuItem r1 = new JMenuItem("Update Student");
		JMenuItem r2 = new JMenuItem("Update Lecturer");
		report.setForeground(Color.BLACK);

		r1.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon5.png"));
		Image image7 = icon7.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
		r1.setIcon(new ImageIcon(image7));
		r1.setMnemonic('E');
		r1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_I, ActionEvent.CTRL_MASK));
		r1.setBackground(Color.WHITE);

		r1.addActionListener(this);

		r2.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon6.png"));
		Image imagee = iconn.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
		r2.setIcon(new ImageIcon(imagee));
		r2.setMnemonic('F');
		r2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T, ActionEvent.CTRL_MASK));
		...
		JMenuItem s2 = new JMenuItem("Fee Form");
		fee.setForeground(Color.BLACK);

		s1.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon7.png"));
		...
		ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon8.png"));
		Image image17 = icon16.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
		s2.setIcon(new ImageIcon(image17));
		s2.setMnemonic('H');
		s2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_H, ActionEvent.CTRL_MASK));
		...
		ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon9.png"));
		...
		ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon10.png"));
		...
		ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon11.png"));
		...
		JMenuItem aboutus = new JMenuItem("University Of Glasgow");
		about.setForeground(Color.BLACK);

		aboutus.setFont(new Font("monospaced", Font.BOLD, 16));
		ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon13.jpg"));
		...
		aboutus.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, ActionEvent.CTRL_MASK));
		...
		ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/icon12.png"));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (msg.equals("New Student")) {
		...
		} else if (msg.equals("New Lecturer")) {
		...
		} else if (msg.equals("Update Lecturer")) {
			...
			System.exit(0);
		} else if (msg.equals("University Of Glasgow")) {
			new AboutUs().setVisible(true);
		} else if (msg.equals("Student Attendance")) {
			new RecordStudentAttendance().setVisible(true);
		} else if (msg.equals("Lecturer Attendance")) {
			new RecordLecturerAttendance().setVisible(true);
		} else if (msg.equals("Student Attendance Detail")) {
			new StudentAttendanceStatus().setVisible(true);
		} else if (msg.equals("Lecturer Attendance Detail")) {
			new LecturerAttendanceStatus().setVisible(true);
		} else if (msg.equals("Examination Details")) {
			new ExaminationDetails().setVisible(true);
		} else if (msg.equals("Input Marks")) {
