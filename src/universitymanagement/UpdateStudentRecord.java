...
public class UpdateStudentRecord implements ActionListener {
	JFrame f;
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == b) {
			if(t12.getText().equals("") || t1.getText().equals("") || t2.getText().equals("") || 
					t3.getText().equals("") ||
					t4.getText().equals("") ||
					t5.getText().equals("") ||
					t6.getText().equals("") ||
			...
			try {
				...
				String str = "update student set name='" + t1.getText() + "',fathers_name='" + t2.getText() + "',age='"
						...
						+ t6.getText() + "',emailid='" + t7.getText() + "',class_x='" + t8.getText() + "',class_xii='"
						+ t9.getText() + "',course='" + t13.getText() + "',branch='"
		...
		if (ae.getSource() == b2) {
			...
			{
			JOptionPane.showMessageDialog(null, "Enter the Roll no. to retrieve data");
			}
			else
			{
			try {
