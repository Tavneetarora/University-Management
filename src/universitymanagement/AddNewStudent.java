...
public class AddNewStudent extends JFrame implements ActionListener {
	...
	public AddNewStudent() {
		...
		id15.setLayout(null);
		ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("universitymanagement/pics/student1.jpg"));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			if (ae.getSource() == b) {
				...
				if (a.equals("") || bb.equals("") || c.equals("") || d.equals("") || e.equals("") || ff.equals("") || g.equals("")
						|| h.equals("") || i.equals("") || k.equals("") || l.equals("") || m.equals("")) 
				{
